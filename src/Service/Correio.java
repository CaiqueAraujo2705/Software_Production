...
public class Correio {
    ...
    private String formatarEmail(Agendamento agendamento) {
        ...
        return "Olá "+ nomeCliente + " obrigado pela preferência ao escolher os nossos serviços... Seu agendamento para "+ servico+", esta marcado para dia "+ dataAgendamento
                +" às "+ horaAgendamento + "\n\n O preço para você fica por R$"+ valor + " \n\nGrande Abraço!!";
    }
